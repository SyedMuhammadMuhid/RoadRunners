                  ...
                  child: Card(
                    ...
                    child: CircleAvatar(
                      ...
                      child: Column(
                        children: [
                          SizedBox(height: 10,),
                          Image(image: AssetImage('assets/propic.png'),height: 70,width: 70,),
                          SizedBox(height: 10,),
                          Text('UserName', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Colors.black87),),
                  ...
                  child: Card(
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index,){
                        ...
                        return Container( height:(height*3)/7, width: MediaQuery.of(context).size.width,
                            child: GestureDetector(
                              onTap: (){
                                Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context)=> profile_info_data[index].screen));
                              },
                              child: Card(
                                child: Row(
                                  children: <Widget>[
                                    ...
                                    SizedBox(width: 14,),
                                    Text(profile_info_data[index].dataName,style: TextStyle(fontSize: 18,),)
